...
1. [Hello World](./examples/hello-world/hello-world.go)
2. [Values](./examples/values/values.go)
3. [Variables](./examples/variables/variables.go)
4. [Constants](./examples/constants/constants.go)
5. [For](./examples/for/for.go)

## Control Flow (Week 1: Day 2-3)
6. [If/Else](./examples/if-else/if-else.go)
7. [Switch](./examples/switch/switch.go)

## Data Structures (Week 1: Day 3)
8. [Arrays](./examples/arrays/arrays.go)
9. [Slices](./examples/slices/slices.go)
10. [Maps](./examples/maps/maps.go)

## Functions (Week 1: Day 3-4)
11. [Functions](./examples/functions/functions.go)
12. [Multiple Return Values](./examples/multiple-return-values/multiple-return-values.go)
13. [Variadic Functions](./examples/variadic-functions/variadic-functions.go)
14. [Closures](./examples/closures/closures.go)
15. [Recursion](./examples/recursion/recursion.go)

## Range & Iteration (Week 1: Day 4)
16. [Range over Built-in Types](./examples/range-over-built-in-types/range-over-built-in-types.go)

## Advanced Concepts (Week 1: Day 4-5)
17. [Pointers](./examples/pointers/pointers.go)
18. [Strings and Runes](./examples/strings-and-runes/strings-and-runes.go)
